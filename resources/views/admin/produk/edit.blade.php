<x-layout>
    ...
    <div x-data="productForm()" x-init="init()">
        ...
        <div x-show="loading" class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity z-40"
            style="display: none;">
                ...
                <div class="mb-8">
                    <div class="flex items-center space-x-3 mb-2">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 mt-1">Edit detail produk di bawah ini</p>
                        </div>
                    </div>
                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="flex items-center space-x-4">
                            <li><a href="{{ route('admin.produk.index') }}"
                                    class="text-gray-500 hover:text-gray-700 transition-colors">Produk</a></li>
                            <li><svg class="flex-shrink-0 h-5 w-5 text-gray-400" fill="currentColor"
                                    viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                    ...
                    <form @submit.prevent="submitForm" enctype="multipart/form-data" class="p-8">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="lg:col-span-2 space-y-6">
                                ...
                                <div class="group">
                                    <label for="name"
                                        class="block text-sm font-semibold text-gray-800 mb-2 flex items-center">
                                    ...
                                    <input id="name" name="name" type="text" x-model="form.name"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="group">
                                        ...
                                        <p x-show="errors.category_id" x-text="errors.category_id"
                                            class="text-red-500 text-sm mt-2 flex items-center">
                                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                                    d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"
                                    ...
                                    <div class="group">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input id="price" name="price" type="number" x-model="form.price"
                                                :class="errors.price ?
                                                    'border-red-300 focus:border-red-500 focus:ring-red-500' :
                                                    'border-gray-300 focus:border-indigo-500 focus:ring-indigo-500'"
                                        ...
                                        <p x-show="errors.price" x-text="errors.price"
                                            class="text-red-500 text-sm mt-2 flex items-center">
                                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                                    d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"
                                ...
                                <div class="group">
                                    ...
                                    <textarea id="description" name="description" rows="4" x-model="form.description"
                            ...
                            <div class="space-y-6">
                                ...
                                <div
                                    class="bg-gray-50 p-6 rounded-2xl border-2 border-dashed border-gray-200 hover:border-indigo-300 transition-colors">
                                    ...
                                    <template x-if="imagePreview">
                                        <div class="relative mb-4 group">
                                            ...
                                            <div
                                                class="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition-opacity rounded-xl flex items-center justify-center">
                                    ...
                                    <div :class="{ 'hidden': imagePreview }" class="text-center">
                                        ...
                                        <div class="space-y-2">
                                            <label for="image" class="cursor-pointer">
                                                ...
                                                <input @change="handleImageUpload($event)" id="image"
                                                    name="image" type="file" class="sr-only" accept="image/*">
                                            </label>
                                            <p class="text-xs text-gray-500">PNG, JPG, GIF maksimal 2MB</p>
                                        </div>
                                    </div>
                                    <p x-show="errors.image" x-text="errors.image"
                                        class="text-red-500 text-sm mt-2 flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                                                d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"
                                ...
                                <div
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div
                                            class="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-200 hover:shadow-sm transition-shadow">
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div>
                                                    <label for="is_available"
                                                        class="font-medium text-gray-700 cursor-pointer">Tersedia</label>
                                                    <p class="text-sm text-gray-500">Produk ini ready stock dan bisa
                                                        dipesan</p>
                                                </div>
                                            </div>
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                <input id="is_available" name="is_available" type="checkbox"
                                                    x-model="form.is_available" class="sr-only peer">
                                                <div
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-start space-x-3">
                                                ...
                                                <div>
                                                    <label for="is_active"
                                                        class="font-medium text-gray-700 cursor-pointer">Aktif</label>
                                                    <p class="text-sm text-gray-500">Tampilkan produk ini di menu utama
                                                    </p>
                                                </div>
                                            </div>
                                            <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <div
                            class="mt-10 pt-6 border-t border-gray-200 flex flex-col sm:flex-row sm:justify-end space-y-3 sm:space-y-0 sm:space-x-4">
    ...
    <script>
        function productForm() {
            return {
                productId: {{ $productId }},
                loading: false,
                imagePreview: '{{ $product->products ? asset($product->products) : null }}',
                existingImage: '{{ $product->products ? asset($product->products) : null }}',
                imageRemoved: false,
                form: {
                    ...
                    is_available: {{ old('is_available', $product->is_available) ? 'true' : 'false' }},
                ...
                async submitForm(event) {
                    ...
                    try {
                        ...
                        const response = await fetch(`/admin/produk/${this.productId}`, {
                            method: 'POST',
                            body: formData,
                            headers: {
                        ...
                        if (response.ok) {
                            this.showNotification('success', 'Produk berhasil diupdate!');
                            setTimeout(() => {
