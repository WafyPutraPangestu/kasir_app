    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto">
            ...
            <nav class="flex mb-8" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-4">
                    ...
                    <li class="flex items-center">
                        ...
                        <span class="ml-4 text-gray-700 font-medium">Edit Kategori</span>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-sm text-gray-600">Perbarui nama kategori untuk mengorganisir produk Anda.</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-gray-50 to-blue-50 px-8 py-6 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900">Formulir Edit Kategori</h2>
                </div>
                <div class="p-8">
                    <div x-data="{ 
                        isSubmitting: false,
                        ...
                        <form method="POST" action="{{ route('admin.category.update', $category) }}" x-ref="form">
                            @csrf
                            @method('PUT')
                            <div class="space-y-6">
                                <!-- Input Nama Kategori -->
