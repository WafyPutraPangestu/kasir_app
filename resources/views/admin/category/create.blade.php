                ...
                <ol class="flex items-center space-x-4">
                    <li class="flex items-center">
                        ...
                        <a href="{{ route('admin.category.index') }}"
                            class="ml-4 text-gray-500 hover:text-indigo-600">Kategori</a>
                    </li>
                    <li class="flex items-center">
                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <form method="POST" action="{{ route('admin.category.store') }}" x-ref="form">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input id="name" name="name" type="text" value="{{ old('name') }}"
                                            required autofocus placeholder="Masukkan nama kategori..."
                            ...
                            <div class="mt-8 pt-6 border-t border-gray-200">
                                <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4">
                                    ...
                                    <button type="button" x-on:click="submitForm()" x-bind:disabled="isSubmitting"
                                        ...
                                        <svg x-show="isSubmitting" class="animate-spin w-4 h-4 mr-2" fill="none"
                                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span x-text="isSubmitting ? 'Menyimpan...' : 'Simpan Kategori'">Simpan
                                            Kategori</span>
                                    </button>
                                </div>
                            </div>
    ...
    @push('scripts')
        <script>
            ...
            function showToast(message, type = 'success') {
                ...
                toast.id = toastId;
                toast.className =
                    `${bgColor} text-white px-6 py-4 rounded-lg shadow-lg transform transition-transform duration-300 ease-in-out max-w-sm flex items-center`;
                toast.innerHTML = `
