<x-layout>
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto">
            ...
            <nav class="flex mb-8" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-4">
                    <li class="flex items-center">
                        ...
                        <a href="{{ route('admin.category.index') }}" class="ml-4 text-gray-500 hover:text-indigo-600">Kategori</a>
                    </li>
                    <li class="flex items-center">
                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                        <span class="ml-4 text-gray-700 font-medium">Tambah Kategori</span>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-sm text-gray-600">Buat kategori baru untuk mengorganisir produk Anda.</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-gray-50 to-blue-50 px-8 py-6 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900">Formulir Kategori</h2>
                </div>
                <div class="p-8">
                    <div x-data="{ 
                        isSubmitting: false,
                        ...
                        <form method="POST" action="{{ route('admin.category.store') }}" x-ref="form">
                            @csrf
                            <div class="space-y-6">
                                <!-- Input Nama Kategori -->
                                <div>
                                    ...
                                    <div class="relative">
                                        <input id="name" 
                                               ...
                                               class="block w-full px-4 py-3 rounded-xl border-2 border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all duration-200 text-gray-900 placeholder-gray-400 bg-gray-50 focus:bg-white {{ $errors->has('name') ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : '' }}">
                                    ...
                                    <p class="mt-2 text-sm text-gray-500 flex items-center">
                                        ...
                                        Nama kategori harus unik dan akan digunakan untuk mengorganisir produk
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="mt-8 pt-6 border-t border-gray-200">
                                <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4">
                                    ...
                                    <button type="button" 
                                        ...
                                        <svg x-show="!isSubmitting" class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                        </svg>
                                        <svg x-show="isSubmitting" class="animate-spin w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                        </svg>
                                        <span x-text="isSubmitting ? 'Menyimpan...' : 'Simpan Kategori'">Simpan Kategori</span>
                                    </button>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        ...
        function showToast(message, type = 'success') {
            ...
            toast.id = toastId;
            toast.className = `${bgColor} text-white px-6 py-4 rounded-lg shadow-lg transform transition-transform duration-300 ease-in-out max-w-sm flex items-center`;
            toast.innerHTML = `
