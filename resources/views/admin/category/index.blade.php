<x-layout>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="hidden sm:table-cell px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                    Slug
                                </th>
                                <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
    ...
    <script>
        ...
        function showToast(message, type = 'success') {
            ...
            toast.id = toastId;
            toast.className = `${bgColor} text-white px-6 py-4 rounded-lg shadow-lg transform translate-x-full transition-transform duration-300 ease-in-out max-w-sm`;
            toast.innerHTML = `
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
        ...
        function showDeleteConfirmation(categoryId, categoryName, productsCount) {
            ...
            if (productsCount > 0) {
                message.innerHTML = `Kategori "<strong>${categoryName}</strong>" memiliki ${productsCount} produk dan tidak dapat dihapus.`;
                document.getElementById('confirmDelete').style.display = 'none';
            } else {
                message.innerHTML = `Apakah Anda yakin ingin menghapus kategori "<strong>${categoryName}</strong>"? Tindakan ini tidak dapat dibatalkan.`;
