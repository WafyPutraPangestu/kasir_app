                        ...
                        @empty
                            <div class="col-span-full text-center py-12">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-xs sm:text-sm text-gray-500 mb-4">Mulai dengan menambahkan meja
                                        pertama Anda</p>
                                    <a href="{{ route('admin.tables.create') }}"
    ...
    @push('scripts')
        <script>
            ...
            function showDeleteConfirmation(tableId, tableName) {
                ...
                message.innerHTML =
                    `Apakah Anda yakin ingin menghapus meja "<strong>${tableName}</strong>"? Tindakan ini tidak dapat dibatalkan.`;
