            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 bg-white rounded-lg shadow">
                    ...
                    <div class="divide-y divide-gray-100">
                        ...
                        <div class="p-5">
                            <!-- Header Pesanan -->
                            <div class="flex items-center justify-between mb-3 cursor-pointer" @click="toggleOrderDetail({{ $order->id }})">
                                <div class="flex items-center">
                                ...
                                <div class="text-right flex items-center">
                                    ...
                                    <svg class="w-5 h-5 text-gray-400 transform transition-transform" :class="{'rotate-180': openOrder === {{ $order->id }}}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div x-show="openOrder === {{ $order->id }}" x-collapse class="mt-4 bg-gray-50 rounded-lg p-4">
                                <div class="space-y-3">
