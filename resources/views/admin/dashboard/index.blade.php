<x-layout>
  <div class="min-h-screen bg-gray-50" x-data="dashboardManager()">
      <!-- Header yang disesuaikan dengan sidebar baru -->
      <div class="bg-white shadow-sm border-b">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div class="py-4 flex items-center justify-between">
                  <div>
                      <h1 class="text-2xl font-bold text-gray-900">Dashboard Admin</h1>
                      <p class="text-gray-600 mt-1 text-sm">Selamat datang kembali! Berikut ringkasan coffeeshop hari ini.</p>
                  </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
              ...
              <div class="bg-white rounded-lg shadow p-5 hover:shadow-md transition-shadow">
                  <div class="flex items-center">
                      ...
                      <div class="ml-4">
                          <p class="text-sm font-medium text-gray-600">Status Meja</p>
                          <div class="flex space-x-3 mt-2">
                              <div class="text-center">
                                  <p class="text-lg font-bold text-green-600">{{ $tableStats['available'] }}</p>
                                  <p class="text-xs text-gray-500">Kosong</p>
                              </div>
                              <div class="text-center">
                                  <p class="text-lg font-bold text-red-600">{{ $tableStats['occupied'] }}</p>
                                  <p class="text-xs text-gray-500">Terisi</p>
                              </div>
                              <div class="text-center">
                                  <p class="text-lg font-bold text-yellow-600">{{ $tableStats['reserved'] }}</p>
              ...
              <div class="bg-white rounded-lg shadow p-6">
                  ...
                  <div class="space-y-3">
                      ...
                      <div class="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                          ...
                          <div class="text-right">
                              <p class="font-semibold text-gray-900">Rp {{ number_format($item->product->price, 0, ',', '.') }}</p>
                          </div>
                      </div>
                      @empty
              ...
              <div class="lg:col-span-2 bg-white rounded-lg shadow">
                  <div class="px-6 py-4 border-b border-gray-200">
                      <div class="flex items-center justify-between">
                          ...
                          <a href="{{ route('admin.orders.index') }}" class="text-sm text-blue-600 hover:text-blue-900 flex items-center">
                              Lihat Semua
                  ...
                  <div class="divide-y divide-gray-100">
                      ...
                      <a href="{{ route('admin.orders.show', $order->id) }}" class="block p-5 hover:bg-gray-50 transition-colors">
                          <div class="flex items-center justify-between">
                              <div class="flex items-center">
                                  <div class="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-4">
                                      <span class="text-sm font-bold text-blue-600">#{{ str_pad($order->id, 2, '0', STR_PAD_LEFT) }}</span>
                                  </div>
                                  <div>
                                      <p class="font-medium text-gray-900">{{ $order->table->name }}</p>
                                      <p class="text-xs text-gray-500 mt-1">{{ $order->items->sum('quantity') }} items • {{ $order->created_at->diffForHumans() }}</p>
                                  </div>
                              </div>
                              <div class="text-right">
