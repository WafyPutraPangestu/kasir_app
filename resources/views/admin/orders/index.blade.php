<x-layout>
    <div x-data="orderDashboard" x-cloak class="container mx-auto p-4 sm:p-6 lg:p-8 font-sans">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div
                class="bg-white p-6 rounded-xl shadow-lg border border-gray-100 flex items-center space-x-4 transform hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div class="mb-6 p-4 bg-white border border-gray-200 rounded-xl shadow-sm">
                        <div class="flex flex-col lg:flex-row lg:items-end gap-4">
                            ...
                            <div class="flex-shrink-0">
                                ...
                                <div
                                    class="flex items-center border border-gray-200 rounded-lg p-1 bg-gray-50 space-x-1">
                ...
                <div class="p-6">
                    ...
                    <div>
                        <template x-if="isLoading.modal">
                            <div class="text-center py-12"><svg
                                    class="animate-spin mx-auto h-8 w-8 text-indigo-600 mb-4"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10"
                                        stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor"
                            ...
                            <div class="space-y-6">
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-3">
                                        ...
                                        <p><span :class="getStatusClass(modal.data.status)"
                                                class="text-xs font-semibold px-3 py-1.5 rounded-full"
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm text-gray-500"><span
                                                            x-text="item.quantity"></span> x <span
                                                            x-text="formatCurrency(item.price)"></span></p>
                                                </div>
                                                <p class="font-semibold text-gray-800"
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('orderDashboard', () => ({
                ...
                init() {
                    ...
                    console.log('Order Dashboard V6 (Enhanced Filter) Initialized');
                },
                ...
                async updateStatus(orderId, newStatus) {
                    ...
                    try {
                        ...
                        if (['completed', 'cancelled'].includes(updatedOrder.status)) {
                            ...
                            if (!this.orderHistory.some(r => r.id === updatedOrder.id)) this
